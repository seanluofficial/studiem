...
export default function NavBar({ displayName, elo, subject, onFriendsClick, friendsBadge, onPracticeClick, placement }: NavBarProps) {
  return (
        ...
        {(displayName || elo != null || subject) && (
          <>
            <div className="flex items-center gap-3 pr-4">
              ...
              {elo != null && <RankBadge elo={elo} size="sm" placement={placement} />}
              {subject && (
